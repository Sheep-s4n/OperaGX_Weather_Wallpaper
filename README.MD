...
python3 main.py
```
Alternatively, you can use the **[launch_daemon.vbs](https://github.com/Sheep-s4n/calculator/blob/main/launch_daemon.vbs)** file in windows the launch the script in the background
